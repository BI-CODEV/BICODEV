! function(t) {
    ...
    if (c) a && (module.exports = c);
        ...
        var d = Object.getPrototypeOf,
            g = d && d(d(P([])));
        g && g !== r && h.call(g, o) && (v = g);
        var m = b.prototype = x.prototype = Object.create(v);
        E.prototype = m.constructor = b, b.constructor = E, b[i] = E.displayName = "GeneratorFunction", c.isGeneratorFunction = function(t) {
            ...
            constructor: N,
            reset: function(t) {
                if (this.prev = 0, this.next = 0, this.sent = this._sent = u, this.done = !1, this.delegate = null, this.method = "next", this.arg = u, this.tryEntries.forEach(G), !t)
            ...
            abrupt: function(t, r) {
                ...
                return i.type = t, i.arg = r, o ? (this.method = "next", this.next = o.finallyLoc, y) : this.complete(i)
            },
    ...
    function w(t, r, e, n) {
        ...
        return i._invoke = function(i, a, c) {
            var u = f;
            return function(t, r) {
                if (u === l) throw new Error("Generator is already running");
                if (u === p) {
                    if ("throw" === t) throw r;
                    return F()
                }
                for (c.method = t, c.arg = r;;) {
                    ...
                    if ("next" === c.method) c.sent = c._sent = c.arg;
                        ...
                        if (u === f) throw u = p, c.arg;
                        c.dispatchException(c.arg)
                    } else "return" === c.method && c.abrupt("return", c.arg);
                    u = l;
                    var o = L(i, a, c);
                    if ("normal" === o.type) {
                        if (u = c.done ? p : s, o.arg === y) continue;
                        return {
                            value: o.arg,
                            done: c.done
                        }
    ...
    function O(t, r) {
        ...
        if (e === u) {
            if (r.delegate = null, "throw" === r.method) {
                if (t.iterator.return && (r.method = "return", r.arg = u, O(t, r), "throw" === r.method)) return y;
        ...
        var o = n.arg;
        return o ? o.done ? (r[t.resultName] = o.value, r.next = t.nextLoc, "return" !== r.method && (r.method = "next", r.arg = u), r.delegate = null, y) : o : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y)
    }
